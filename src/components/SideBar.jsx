...
const Sidebar = () => {
  ...
  const menuItems = [
    { id: 'dashboard', text: 'Dashboard', icon: <LayoutDashboard size={18} />, path: '/dashboard' },
    { id: 'tenders', text: 'Tenders', icon: <FileText size={18} />, path: '/tenders' },
    { id: 'organizations', text: 'Organizations', icon: <Building2 size={18} />, path: '/organizations' },
    { id: 'vendors', text: 'vendors', icon: <FileCheck size={18} />, path: '/vendors' },
    { id: 'users', text: 'Users', icon: <Users size={18} />, path: '/users' },
    { id: 'projects', text: 'Projects', icon: <Briefcase size={18} />, path: '/projects' },
