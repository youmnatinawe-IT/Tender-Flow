...
// async function fetchAllOrgAccountsData() {
//   const pubRes = await getPublisherOrgs();

//   if (pubRes.error) {
//     throw new Error(
//       "An error occurred while fetching publisher organizations and their accounts data.",
//     );
//   }
...
//   // الناشرين فقط
//   const allOrgsRaw = pubList.map((o) => ({
//     ...o,
//     defaultType: "Publisher",
//   }));
...
//     const load = async () => {
//       try {
//         const orgs = await fetchAllOrgAccountsData();
//         if (cancelled) return;
...
//         setError(
//           "An error occurred while fetching organizations and their accounts data.",
//         );
//       } finally {
...
//           (acc.f_name &&
//             acc.f_name.toLowerCase().includes(searchTerm.toLowerCase())),
//       );
...
//             <p>
//               Overview of all registered organizations and their designated
//               bidding accounts and team representatives.
//             </p>
//           </div>
//         </div>
...
//                               }}
//                             >
//                               No accounts have been generated for this
//                               organization yet.
//                             </span>
//                           </div>
